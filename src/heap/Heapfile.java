...
public class Heapfile implements Filetype,  GlobalConst {
  ...
  */
  private boolean  _findDataPage( MID mid,
	...
	{// Start While01
	  ...
	  for( currentDataPageMid = currentDirPage.firstMap();
	    ...
	    {
	      try{
	    	  // Not sure if this should be kept as tuple or changed to map since it concerns the directory page
		...
		{
		  MAP amap = currentDataPage.returnMap(mid);
   ...
   */
  // I think changing this to MAP is okay because it seems to be used for data pages only
