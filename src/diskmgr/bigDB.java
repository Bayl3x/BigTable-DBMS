 ...
 public class bigDB implements GlobalConst {
  ...
  //counts the number of reads and writes
 ...
 /**
  * bigDBFirstPage class which is a subclass of bigDBHeaderPage class
  */
 ...
 /**
  * bigDBDirectoryPage class which is a subclass of bigDBHeaderPage class
  */
 class bigDBDirectoryPage extends bigDBHeaderPage  { //implements PageUsedBytes
    ...
    * Default constructor
    */
   public bigDBDirectoryPage ()  { super(); }
